...
/* ─── Bullet icon ────────────────────────────────────── */
const BulletCheck = () => (
  <svg className="w-3.5 h-3.5 text-cyan flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
    <circle cx="10" cy="10" r="10" className="text-cyan/15" fill="currentColor" />
    <path stroke="white" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" fill="none" d="M6 10l3 3 5-5" />
  </svg>
)
...
function PartnerCard({ p, delay = 0 }) {
  ...
  return (
    <AnimateIn delay={delay} className={isWide ? 'md:col-span-1' : ''}>
      <div className="group h-full bg-white border border-gray-100 rounded-2xl p-6 shadow-card
        ...
        {p.reasonsTitle && (
          <>
            <h4 className="font-bold text-cyan text-sm mb-3">{p.reasonsTitle}</h4>
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          ...
          <AnimateIn className="text-center mb-12">
            ...
            <p className="mt-3 text-navy/55 max-w-xl mx-auto text-base">
              Whether you're a payment provider, a bank, or an advisory firm, we have a tailored solution
              to help your clients grow.
            </p>
          </AnimateIn>
